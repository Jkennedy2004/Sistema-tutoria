...
export default function TutorProfilePage() {
  ...
  console.log('Current content messages:', currentContent.messages)
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    ...
                    <button className="absolute -bottom-1 -right-1 p-1 bg-green-600 text-white rounded-full hover:bg-green-700 transition-colors">
